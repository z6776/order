...
return [
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'VX0azd9LeKoTNq68A3JWYRD1MEOk2msu',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    'fastadmin'              => [
        ...
        'loginip_check'         => true,
        //登录页默认背景图
        'login_background'      => "https://hyh5.mashangke-app.cn/uploads/20240821/999a617e211d6dbe1a9c3c93db0d7b64.png",
        //是否启用多级菜单导航
        'multiplenav'           => false,
        ...
        //允许跨域的域名,多个以,分隔
        'cors_request_domain'   => 'localhost,127.0.0.1,hyh5.mashangke-app.cn',
        //版本号
        'version'               => '1.5.0.20240328',
        //API接口地址
        'api_url'               => 'https://api.fastadmin.net',
    ],
    'base_url' => 'https://hyh5.mashangke-app.cn'
];
