...
(function (window, undefined) {
    ...
    K.options = {
        ...
        htmlTags: {
            ...
            img: ['id', 'class', 'src', 'width', 'height', 'border', 'alt', 'title', 'align', '.width', '.height', '.border', 'data-index'],
    ...
    function _mediaEmbed(attrs) {
        var type = attrs.type.indexOf('video/') > -1 ? 'video' : (attrs.type.indexOf('audio/') > -1 ? 'audio' : 'embed');
        ...
        select: function (hasDummy) {
            ...
            if (_IERANGE) {
                ...
                if (doc !== document) {
                    ...
                    if(sc.children && sc.children.length>1 && sel.focusOffset>1 && typeof sc.children[sel.focusOffset-1]!=='undefined'){
    ...
    function _getInitHtml(options) {
        ...
        bodyClass = bodyClass + ($("body").hasClass("darktheme") ?  " darktheme" : "");
