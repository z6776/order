...
export default {
	...
	methods: {
		...
		setMonths() {
			// 传了的 和 小于当前年份的不能选择过去的月份;
			// console.log(this.valueArr,"this.valueArrthis.valueArr");
			// let month = this.startYear==1950 && new Date().getFullYear() ? 1 : new Date().getMonth()-1; 
			this.months = this.generateArray(1, 12);
			this.valueArr.splice(this.valueArr.length - 1, 1, this.getIndex(this.months, this.month));
		},
		setDays() {
			// 传了的不能选择过去的时间;
			// let day = this.startYear==1950 ? 0 : new Date().getDate(); 
